        ...
        {TABS.map((tab) => (
          <button
            ...
            style={{
              ...
              background: activeTab === tab ? "#2d7a3a" : "#fff",
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={!canReceive}
                        style={{
                          background: canReceive ? "#2d7a3a" : "#e0e0e0",
                          color: canReceive ? "#fff" : "#aaa",
                          border: "none",
                          borderRadius: "20px",
                          padding: "10px 18px",
                          fontSize: "13px",
                  ...
                  {selectedOrder.items.map((item, i) => (
                    ...
                    >
                      <div>
                        ...
                        <p
                          style={{ fontSize: "11px", color: "#aaa", margin: 0 }}
                        >
                          qty: {item.qty}
                        </p>
                      </div>
                      ...
                      background:
                        selectedOrder.status === "Received"
                          ...
                          : canReceive
                            ...
                            : "#e0e0e0",
                      color:
                        canReceive || selectedOrder.status === "Received"
                          ? "#fff"
                          : "#aaa",
                      fontSize: "14px",
                      fontWeight: 700,
