...
const getEmoji = (name: string): string => {
  ...
  if (n.includes("sprite") || n.includes("7up") || n.includes("mountain"))
    return "💚";
  if (n.includes("fanta") || n.includes("orange") || n.includes("royal"))
    return "🍊";
...
export default function InventoryMaintenancePage() {
  ...
  return (
    <div style={{ padding: "28px" }}>
      ...
      <div
        style={{
          background: "linear-gradient(135deg, #6366f1, #3c3eb1fb)",
          borderRadius: "16px",
          padding: "24px 32px",
          marginBottom: "24px",
          display: "flex",
        ...
        <>
          ...
          >
            <div
              style={{
                height: "160px",
                background: getBgColor(selected.productName),
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: "72px",
            ...
            <div style={{ padding: "24px" }}>
              ...
              {[
                ...
                ["📦 Stock Level", `${selected.stock} case`],
