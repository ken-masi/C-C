...
const existingCustomers: ExistingCustomer[] = [
  {
    ...
    storeName: "Kens Sari-Sari Store",
    phone: "09321431241",
    email: "ken@email.com",
  },
  {
  ...
  },
  {
    id: 6,
    name: "Rosa Garcia",
    address: "987 Narra St, Caloocan",
    storeName: "Garcia Convenience",
    phone: "09121234567",
...
export default function PaymentPage() {
  ...
  const [customerType, setCustomerType] =
    useState<CustomerType>("Existing Customer");
  ...
  const cartItems = [
    { name: "Coca Cola 1.5L", qty: 1, price: 80 },
    { name: "Sprite 1.5L", qty: 1, price: 35 },
  ];
      ...
      >
        <div style={{ textAlign: "center", padding: "40px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#888", marginBottom: "6px" }}>
            Payment received from <strong>{activeCustomer?.name}</strong>.
          </p>
          <p style={{ fontSize: "14px", color: "#888", marginBottom: "6px" }}>
            Total: <strong style={{ color: "#1a3c2e" }}>₱{subtotal}.00</strong>
          </p>
        ...
        >
          ...
          >
                    ...
                    style={{
                      ...
                      border:
                        paymentMethod === m
                          ? "2px solid #1a3c2e"
                          : "1px solid #e0e0e0",
                      background: paymentMethod === m ? "#f0faf2" : "#fff",
                      color: paymentMethod === m ? "#1a3c2e" : "#555",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      gap: "6px",
            ...
            <div style={{ marginBottom: "22px" }}>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                {(["New Customer", "Existing Customer"] as CustomerType[]).map(
                  (t) => (
                    <button
                      key={t}
                      onClick={() => {
                      ...
                      style={{
                        ...
                        border:
                          customerType === t
                            ? "2px solid #1a3c2e"
                            : "1px solid #e0e0e0",
                        background: customerType === t ? "#f0faf2" : "#fff",
                        color: customerType === t ? "#1a3c2e" : "#555",
                      }}
                    >
                      {t === "New Customer" ? "🆕" : "👥"} {t}
                    </button>
              ...
              <div style={{ marginBottom: "22px" }}>
                ...
                <div style={{ position: "relative" }}>
                  <input
                    ...
                    placeholder="Type customer name, store, or phone..."
            ...
            {paymentMethod === "GCash" && (
              ...
              >
                ...
                {(!gcashRef || !gcashImage) && (
                  ...
                  >
                    ⚠️ Reference number and receipt image are required.
                  </p>
                )}
              </div>
            )}
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "13px" }}>₱{subtotal}.00</span>
              </div>
              <div
                style={{
                  display: "flex",
