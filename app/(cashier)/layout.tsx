    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "#f4f6fb" }}>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: "13.5px", fontWeight: 700, color: "#1e1b4b", letterSpacing: "-0.01em", lineHeight: 1.2 }}>
              Julieta Store
            </p>
            <p style={{ fontSize: "11px", color: "#a5b4fc", fontWeight: 500, marginTop: "2px" }}>
              Cashier Panel
            </p>
          </div>
        </div>
